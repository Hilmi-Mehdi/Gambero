            ...
            <nav class="nav bd-container">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item"><a href="../../Dashboard/Pages/Login.php" class="nav__link"> Login </a></li>
                    </ul>
                </div>
        ...
        <main class="l-main">
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title">GAMBERO</h1>
                        <h2 class="home__subtitle">Try the best food of <br> the city.</h2>
            ...
            <section class="app section bd-container">
                <div class="app__container bd-grid">
                    <div class="app__data">
                        <span class="section-subtitle app__initial">Staff</span>
                        <h2 class="section-title app__initial">Our head chef</h2>
                        <p class="app__description">When visiting our Moroccan restaurant, just brace yourself to immersing into enjoying a truly delicious and perfectly cooked dishes.</p>
                        <div class="app__stores">
                        </div>
                    </div>

                    <img src="../images/chef.png" alt="" class="app__img">
                </div>
            </section>
            ...
            <section class="contact section bd-container" id="contact">
                <div class="contact__container bd-grid">
                    ...
                    <div class="contact__button">
                        <a href="#" class="button">Contact us now</a><br><br>
                        <a href="#" class="button">Book a table now</a>
                    </div>
                </div>
            </section>
        </main>
