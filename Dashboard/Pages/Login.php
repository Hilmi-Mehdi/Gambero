        ...
        if ($stmt = mysqli_prepare($link, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                if (mysqli_num_rows($result) != 0) {
                    ...
                    if ($role == 3) {
                        header("location: ../../Main/Pages/Main.php?id=" . $userid);
                    }
                    exit();
                } else {
        ...
        <div class="contentBx">
            <div class="formBx">
                ...
                <form action="">
                    <div class="inputBx">
                        <span>Username</span>
                        <input type="text" name="user" value="<?php if (isset($_SESSION['user']) and isset($_SESSION['pass'])) {
                                                                    echo $_SESSION['user'];
                                                                } ?>" required>
                    </div>
                    <div class="inputBx">
                        <span>Password</span>
                        <input type="password" name="pass" value="<?php if (isset($_SESSION['user']) and isset($_SESSION['pass'])) {
                                                                        echo $_SESSION['pass'];
                                                                    } ?>" required>
                    </div>
                    <div class="remember">
